"""
Data source	http://socialnetworks.mpi-sws.org/data-wosn2008.html
Vertex type	User
...
Size	3,223,589 vertices (users)
Volume	9,375,374 edges (friendships)
Average degree	5.8167 edges / vertex
...
def read_txt_file():
    #read the txt file
    lines = np.genfromtxt("out.youtube-u-growth.txt", dtype= int)
    return lines
...
def generate_dynamic_graph(time_step_number = 5):
    lines = read_txt_file()
    """
    min_mum_non_zero_time = 1165708800
    max_mum_time = 1185148800
