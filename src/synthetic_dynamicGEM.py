...
def generate_dynamic_graphs( node_num = 1000,community_num = 2,node_change_num = 5,length = 5,target_community = 1,migrate_number = 7):

    dynamic_sbm_series = get_community_diminish_series_v2(node_num,
                                     community_num,
                                     length,
                                     target_community,
                                     migrate_number)
