...
def load_dynamic_graphs(path):
    ''' load a series of networkx dynamic graphs from pickle file
    '''
...
def load_static_graph(path):
    ''' load a static networkx graph from pickle file
    '''
    with open(path, 'rb') as f:
